...
if ((!ipjIsChrome) && (window.showModalDialog)){
...
if ((!ipjIsChrome) && (ipjIsFF3OrGreater || ipjIsSafari))
{
window.top.returnValue=returnValue;
window.top.close();
}
else if ((!ipjIsChrome) && (window.showModalDialog))
{
window.close();
...
if (returnValue=="true" || returnValue==true || ipjIsChrome) {
